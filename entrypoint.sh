...
docker run -e INPUT_CACHING -e INPUT_PROJECTLOCATION -e INPUT_SRCDIRECTORY -e INPUT_PACKAGEDIRECTORIES -e INPUT_PACKAGES -e INPUT_EXCLUDEPACKAGES -e INPUT_CHOP -e INPUT_VIPERBACKEND -e INPUT_JAVAXSS -e INPUT_JAVAXMX -e INPUT_GLOBALTIMEOUT -e INPUT_PACKAGETIMEOUT -e GITHUB_WORKSPACE -e GITHUB_REPOSITORY \
