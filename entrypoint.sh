...
docker run -e INPUT_CACHING -e INPUT_PROJECTLOCATION -e INPUT_PACKAGEDIRECTORIES -e INPUT_PACKAGES -e INPUT_JAVAXSS -e INPUT_JAVAXMX -e INPUT_GLOBALTIMEOUT -e INPUT_PACKAGETIMEOUT -e INPUT_VIPERBACKEND -e GITHUB_WORKSPACE -e GITHUB_REPOSITORY \
