...
do
	...
	if timeout "$INPUT_PACKAGETIMEOUT" sh -c "java -Xss$INPUT_JAVAXSS -Xmx$INPUT_JAVAXMX -jar $GOBRA_JAR -i $CMDARG -I $PROJECT_LOCATION --backend $INPUT_VIPERBACKEND"; then
